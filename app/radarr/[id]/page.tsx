...
import {
  ArrowLeft, Film, Eye, EyeOff, RefreshCw, Search,
...
export default function RadarrDetailPage() {
    ...
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex flex-col items-center justify-center flex-1 gap-3">
          ...
          <Link href="/radarr" className="text-[var(--color-radarr)] text-sm hover:underline">
            ← Back to library
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header title={movie.title} subtitle={`${movie.year}${movie.runtime ? ` · ${formatRuntime(movie.runtime)}` : ""}`} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr]">
          ...
          <aside className="lg:border-r border-[var(--color-border)] p-5 space-y-6">
            ...
            <div className="flex flex-col gap-2">
              <Link href="/radarr" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-[var(--color-text-secondary)] hover:text-white border border-[var(--color-border)] hover:border-[var(--color-border-bright)] transition-all">
